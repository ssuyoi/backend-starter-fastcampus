package com.backendstarter.testdata.util;
...
//                        "&nullStr=" + // null 파라미터는 제외
    ...
    @DisplayName("객체와 인코딩 여부가 주어지면, form body data 형식의 문자열을 반환한다.")
    @Test
    void givenObjectAndWhetherToEncode_whenEncoding_thenReturnsFormEncodedString() {
        // Given
        TestObject obj = new TestObject(
            "This 'is' \"test\" string.",
            List.of("hello", "my", "friend").toString().replace(" ", ""),
